...
class PackageFormComponent extends React.Component {
    ...
    getFields() {
        let fields = [
            ...
            { name:'meals', placeholder: 'ארוחות', value: this.state.form['meals'], onUpdate: this.updateField },
            { name:'accommodation', placeholder: 'לינה', value: this.state.form['accommodation'], onUpdate: this.updateField },
            { name:'price', placeholder: 'מחיר', value: this.state.form['price'], onUpdate: this.updateField },
