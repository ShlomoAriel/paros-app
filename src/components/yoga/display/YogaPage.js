  ...
  return (
      <main className="page-content">
        ...
        <section className="section-md-top-145 section-sm-bottom-153 section-34">
          <div className="shell">
            <h2 className="divider text-center">{yoga.yogaTitle.value}</h2>
            <div className="range">
              <div className="cell-md-4"><img src={yoga.yogaImage.value} alt="" width="370" height="286"/></div>
              <div className="cell-md-8 txt-base">
                <div className="inset-md-right-30">
                  <div className="h5">{yoga.mainDescription.value}</div>
                </div>
              </div>
            </div>
            <div className="range">
              <div className="cell-md-8 txt-base">
                <div className="inset-md-right-30">
                  <div className="h5 rtl">{yoga.secondDescription.value}</div>
                </div>
              </div>
              <div className="cell-md-4"><img src={yoga.yogaImage2.value} alt="" width="370" height="286"/></div>
            </div>
            <div className="range">
              <div className="cell-md-4"><img src={yoga.yogaImage3.value} alt="" width="370" height="286"/></div>
              <div className="cell-md-8 txt-base">
                <div className="inset-md-right-30">
                  <div className="h5">{yoga.thirdDescription.value}</div>
                </div>
              </div>
            </div>
          </div>
