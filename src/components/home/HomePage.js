            ...
            <div className="range">
              <div className="cell-md-10 cell-md-preffix-1">
                <h5 className="txt-base">
                	בואו לחוות ימים קסומים של תרגול יוגה אכילה טובה והטבע המרהיב של פארוס.
  תרגול יוגה  באויר הפתוח בנקודות שונות באי.     מסלולי הליכה מרהבים בליווי פיקניק ופינוקים, ארחות גורמה במסעדות הנבחרו בקפידה ומארוחות שף אישיות מותאמת למזג האויר טריות השוק ולתזונתו של האורח. 
  בין תרגול יוגה לארוחה, בין מנוחה למנוחה מציא האי פאורס חופים מטריפים ספורט ימי רכיבה על סוסים מוסיקה פסטיבלים ושפע של טבע כפרי בחופשה מאורגנת ומשולמת מראש בתקציב ובקצב שלכם.  
                </h5>
              </div>
            </div>
          </div>
