  ...
  return (
      <main className="page-content">
        ...
        <section className="section-md-top-145 section-sm-bottom-153 section-34">
          <div className="shell">
            <h2 className="divider text-center">{food.foodTitle.value}</h2>
            <div className="range">
              <div className="cell-md-4"><img src={food.foodImage.value} alt="" width="370" height="286"/></div>
              <div className="cell-md-8 txt-base">
                <div className="inset-md-right-30">
                  <div className="h5">{food.mainDescription.value}</div>
                </div>
              </div>
            </div>
            <div className="range">
              <div className="cell-md-8 txt-base">
                <div className="inset-md-right-30">
                  <div className="h5 rtl">{food.secondDescription.value}</div>
                </div>
              </div>
              <div className="cell-md-4"><img src={food.foodImage2.value} alt="" width="370" height="286"/></div>
            </div>
            <div className="range">
              <div className="cell-md-4"><img src={food.foodImage3.value} alt="" width="370" height="286"/></div>
              <div className="cell-md-8 txt-base">
                <div className="inset-md-right-30">
                  <div className="h5">{food.thirdDescription.value}</div>
                </div>
              </div>
            </div>
          </div>
